...
<div class="font-[sans-serif]">
      <div class="grid lg:grid-cols-2 gap-4 max-lg:gap-12 bg-gradient-to-r from-blue-500 to-blue-700 px-8 py-12 h-[320px]">
        ...
        <div class="bg-white rounded-xl sm:px-6 px-4 py-8 max-w-md w-full h-max shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] max-lg:mx-auto">
          <form>
            ...
            <div class="mt-8">
              <button type="button" class="js-input-login w-full shadow-xl py-3 px-6 text-sm font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                Log in
              </button>
            </div>
            <p class="text-sm mt-8 text-center text-gray-800">Don't have an account <a href="/src/index.php/user/register" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
          </form>
        </div>
      </div>
    </div>
    ...
    <script>
      const loginBtn = document.querySelector('.js-input-login');
      loginBtn.addEventListener('click', () => {
        location.href = "/src/index.php/user/dashboard";
      });
